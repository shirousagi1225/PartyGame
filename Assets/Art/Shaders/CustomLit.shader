    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half3 LightingBased(half3 lightColor, half3 lightDirectionWS, half lightAttenuation, half3 normalWS, half3 viewDirectionWS)
            {
                ...
                half3 radiance = lightColor * (lightAttenuation * NdotL) * _BaseColor.rgb;
                // BlinnPhong高光反射
                half3 halfDir = normalize(lightDirectionWS + viewDirectionWS);
                half3 specular = lightColor * pow(saturate(dot(normalWS, halfDir)), _Smoothness) * _SpecColor.rgb;
            ...
            {
                // 注意light.distanceAttenuation * light.shadowAttenuation，這里已經將距離衰減與陰影衰減進行了計算
            ...
            half4 LitPassFragment(Varyings input) : SV_Target
            {
                ...
                return half4(color * (ambient + diffuse), 1.0);
            }
